...
export declare const ComponentContext: any;
export declare const ComponentProvider: <StreamChatGenerics extends unknown = any, V extends CustomTrigger = CustomTrigger>({ children, value, }: PropsWithChildren<{
    value: Partial<ComponentContextValue<StreamChatGenerics, V>>;
}>) => any;
export declare const useComponentContext: <StreamChatGenerics extends unknown = any, V extends CustomTrigger = CustomTrigger>(componentName?: string) => ComponentContextValue<StreamChatGenerics, V>;
/**
 * Typescript currently does not support partial inference, so if ComponentContext
 * typing is desired while using the HOC withComponentContext, the Props for the
 * wrapped component must be provided as the first generic.
 */
export declare const withComponentContext: <P extends UnknownType, StreamChatGenerics extends unknown = any, V extends CustomTrigger = CustomTrigger>(Component: React.ComponentType<P>) => {
    (props: Omit<P, keyof ComponentContextValue<StreamChatGenerics, V>>): any;
    displayName: any;
};
