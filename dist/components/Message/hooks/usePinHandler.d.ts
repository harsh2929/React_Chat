...
export declare const usePinHandler: <StreamChatGenerics extends unknown = any>(message: any, _permissions?: PinPermissions, notifications?: PinMessageNotifications<StreamChatGenerics>) => {
    canPin: boolean;
