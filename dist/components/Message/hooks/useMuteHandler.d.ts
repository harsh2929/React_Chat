...
export declare const useMuteHandler: <StreamChatGenerics extends unknown = any>(message?: any, notifications?: MuteUserNotifications<StreamChatGenerics>) => ReactEventHandler;
