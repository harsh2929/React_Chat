...
export declare const useFlagHandler: <StreamChatGenerics extends unknown = any>(message?: any, notifications?: FlagMessageNotifications<StreamChatGenerics>) => ReactEventHandler;
