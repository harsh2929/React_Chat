 ...
 */
export declare const ChannelListMessenger: <StreamChatGenerics extends unknown = any>(props: PropsWithChildren<ChannelListMessengerProps<StreamChatGenerics>>) => any;
